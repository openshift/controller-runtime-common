...
# copied from: https://github.com/kubernetes-sigs/cluster-api/blob/main/hack/utils.sh

# This script provides common utility functions used by other scripts in the
# repository. It includes helpers for navigating the project source tree and
