...
// Tool dependencies are defined here.
// The approach followed here is described in the following blog post:
// https://web.archive.org/web/20260128104613/https://www.alexedwards.net/blog/how-to-manage-tool-dependencies-in-go-1.24-plus
// Note:
// we do NOT need or want to use go vendoring for these tools.
// we do NOT want to add extra packages/files in this tools directory aside from modifying go.tool.mod's tool directive.
// Please keep these dependencies updated when updating the main module dependencies.
